...
#pragma clang diagnostic pop
    ...
    OrderUpdate &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    OrderUpdate &securityID(const std::uint32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    OrderUpdate &orderAction(const OrderActionType::Value value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    OrderUpdate &side(const SideType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    OrderUpdate &price(const double value) SBE_NOEXCEPT
    {
        union sbe_double_as_uint_u val;
        val.fp_value = value;
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
...
#pragma clang diagnostic pop
    ...
    OrderUpdate &size(const double value) SBE_NOEXCEPT
    {
        union sbe_double_as_uint_u val;
        val.fp_value = value;
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
...
#pragma clang diagnostic pop
    ...
    OrderUpdate &securitySequence(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
#pragma clang diagnostic pop
    ...
    OrderUpdate &orderID(const std::uint64_t index, const char value)
    {
        if (index >= 36)
        {
    ...
    OrderUpdate &putOrderID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderUpdate &putOrderID(const std::string_view str)
    {
    ...
    #else
    OrderUpdate &putOrderID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 36)
        {
