...
public final class OrderUpdateEncoder
{
    ...
    public OrderUpdateEncoder transactTime(final long value)
    {
    ...
    public OrderUpdateEncoder securityID(final long value)
    {
    ...
    public OrderUpdateEncoder orderAction(final OrderActionType value)
    {
    ...
    public OrderUpdateEncoder side(final SideType value)
    {
    ...
    public OrderUpdateEncoder price(final double value)
    {
    ...
    public OrderUpdateEncoder size(final double value)
    {
    ...
    public OrderUpdateEncoder securitySequence(final long value)
    {
    ...
    public OrderUpdateEncoder orderID(final int index, final byte value)
    {
        if (index < 0 || index >= 36)
        {
    ...
    public OrderUpdateEncoder putOrderID(final byte[] src, final int srcOffset)
    {
        final int length = 36;
    ...
    public OrderUpdateEncoder orderID(final String src)
    {
        final int length = 36;
    ...
    public OrderUpdateEncoder orderID(final CharSequence src)
    {
        final int length = 36;
        final int srcLength = null == src ? 0 : src.length();
        if (srcLength > length)
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final OrderUpdateDecoder decoder = new OrderUpdateDecoder();
