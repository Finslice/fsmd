...
#ifndef _FINSLICE_MD_SIDETYPE_H_
#define _FINSLICE_MD_SIDETYPE_H_
...
enum finslice_md_sideType
{
    finslice_md_sideType_NoSide = (uint8_t)0,
    finslice_md_sideType_Buy = (uint8_t)1,
    finslice_md_sideType_Sell = (uint8_t)2,
    finslice_md_sideType_NULL_VALUE = (uint8_t)255
};

SBE_ONE_DEF bool finslice_md_sideType_get(
    const uint8_t value,
    enum finslice_md_sideType *const out)
{
    ...
    {
        case (uint8_t)0:
             *out = finslice_md_sideType_NoSide;
             return true;
        case (uint8_t)1:
             *out = finslice_md_sideType_Buy;
             return true;
        case (uint8_t)2:
             *out = finslice_md_sideType_Sell;
             return true;
        case (uint8_t)255:
             *out = finslice_md_sideType_NULL_VALUE;
             return true;
    }
