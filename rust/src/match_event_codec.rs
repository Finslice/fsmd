...
pub const SBE_BLOCK_LENGTH: u16 = 120;
...
pub mod encoder {
    ...
    pub struct MatchEventEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for MatchEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for MatchEventEncoder<'a> {
        #[inline]
    ...
    impl<'a> MatchEventEncoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn maker_side(&mut self, value: SideType) {
        ...
        /// - encodedLength: 8
        #[inline]
        pub fn size(&mut self, value: f64) {
        ...
        /// primitive array field 'MakerOrderID'
        /// - min value: 32
        /// - max value: 126
        /// - null value: 0
        ...
        /// - version: 0
        #[inline]
        pub fn maker_order_id(&mut self, value: [u8; 36]) {
        ...
        /// primitive array field 'TakerOrderID'
        /// - min value: 32
        /// - max value: 126
        /// - null value: 0
        /// - characterEncoding: US-ASCII
        ...
        /// - version: 0
        #[inline]
        pub fn taker_order_id(&mut self, value: [u8; 36]) {
...
pub mod decoder {
    ...
    #[derive(Debug, Default)]
    pub struct MatchEventDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl<'a> Reader<'a> for MatchEventDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for MatchEventDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
    ...
    impl<'a> MatchEventDecoder<'a> {
        ...
        /// REQUIRED enum
        #[inline]
        pub fn maker_side(&self) -> SideType {
        ...
        #[inline]
        pub fn maker_order_id(&self) -> [u8; 36] {
        ...
        pub fn trade_id(&self) -> u64 {
            self.get_buf().get_u64_at(self.offset + 76)
        }

        #[inline]
        pub fn taker_order_id(&self) -> [u8; 36] {
            let buf = self.get_buf();
            [
                buf.get_u8_at(self.offset + 84),
                buf.get_u8_at(self.offset + 84 + 1),
                buf.get_u8_at(self.offset + 84 + 2),
                buf.get_u8_at(self.offset + 84 + 3),
                buf.get_u8_at(self.offset + 84 + 4),
                buf.get_u8_at(self.offset + 84 + 5),
                buf.get_u8_at(self.offset + 84 + 6),
                buf.get_u8_at(self.offset + 84 + 7),
                buf.get_u8_at(self.offset + 84 + 8),
                buf.get_u8_at(self.offset + 84 + 9),
                buf.get_u8_at(self.offset + 84 + 10),
                buf.get_u8_at(self.offset + 84 + 11),
                buf.get_u8_at(self.offset + 84 + 12),
                buf.get_u8_at(self.offset + 84 + 13),
                buf.get_u8_at(self.offset + 84 + 14),
                buf.get_u8_at(self.offset + 84 + 15),
                buf.get_u8_at(self.offset + 84 + 16),
                buf.get_u8_at(self.offset + 84 + 17),
                buf.get_u8_at(self.offset + 84 + 18),
                buf.get_u8_at(self.offset + 84 + 19),
                buf.get_u8_at(self.offset + 84 + 20),
                buf.get_u8_at(self.offset + 84 + 21),
                buf.get_u8_at(self.offset + 84 + 22),
                buf.get_u8_at(self.offset + 84 + 23),
                buf.get_u8_at(self.offset + 84 + 24),
                buf.get_u8_at(self.offset + 84 + 25),
                buf.get_u8_at(self.offset + 84 + 26),
                buf.get_u8_at(self.offset + 84 + 27),
                buf.get_u8_at(self.offset + 84 + 28),
                buf.get_u8_at(self.offset + 84 + 29),
                buf.get_u8_at(self.offset + 84 + 30),
                buf.get_u8_at(self.offset + 84 + 31),
                buf.get_u8_at(self.offset + 84 + 32),
                buf.get_u8_at(self.offset + 84 + 33),
                buf.get_u8_at(self.offset + 84 + 34),
                buf.get_u8_at(self.offset + 84 + 35),
            ]
        }
